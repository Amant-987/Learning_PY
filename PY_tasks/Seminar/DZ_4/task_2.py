...
bushes = int(input("Enter number of bushes: "))
bush_berries = [random.randint(5,55) for _ in range(bushes)] #random for berries' quantity
print(bush_berries)
...
print(f"Maximum berries for the one round is {max_sum}")
